...
class SettingsPanel(QWidget):
    ...
    def _build_behavior_tab(self) -> QWidget:
        ...
        self.prerelease_check.setChecked(config.include_prereleases)
        self.prerelease_check.toggled.connect(self._save_settings)
        updates_layout.addWidget(self.prerelease_check)
    ...
    def _save_settings(self) -> None:
        ...
        config.include_prereleases = self.prerelease_check.isChecked()
